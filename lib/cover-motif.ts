...
const motifs = [
  { index: 2, test: /love|crush|heart|feeling|romance|kiss/ }, // heart
  { index: 1, test: /sunset|sunrise|morning|midnight|dawn|dusk|night|dream|lullaby|sunday|sunrise/ }, // horizon
  { index: 7, test: /sleep|calm|idle|slow|soft|quiet|rest|dark|lofi/ }, // crescent
  ...
  { index: 5, test: /async|await|chemistr|component|thread|race|condition|atom|orbit|cycle|promise/ }, // orbit
  { index: 4, test: /energ|push|force|ship|deploy|boot|monday|vibe|beat|drop|bass|fast/ }, // spectrum
  { index: 0, test: /hydrat|water|ripple|backpressure|socket|stream|wave|flow|handshake|reload|hot|echo|pulse/ }, // ripple
] as const;
